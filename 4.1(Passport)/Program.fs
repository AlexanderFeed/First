...
let main argv =
    ...
    Console.WriteLine(Time watch Mass.searchDoc pass1)
    Console.WriteLine(Time watch List.searchDoc pass1)
    Console.WriteLine(Time watch Binya.searchDoc pass1)
    Console.WriteLine(Time watch Set.searchDoc pass1)
